...
public class Constants {
    ...
    public static class ProjectInfo{
        ...
        public static final String FRONT_END_TECH="";
        ...
        public static final String RPC_TECH="dubbo-2.6.0";

        public static final String REGISTRY="zookeeper-3.4.13";

        public static final String CACHES="Redis-3.2.100";

        public static final String DATABASES="Mysql-8.0.13";
        ...
        public static final String FEATURE="响应式 / 清爽 / 极简 / 沙雕";
    }
