...
import com.springmvc.util.MySecurity;
...
public class UserController extends BaseController {
    ...
    public String info(Model model) {
        ...
        model.addAttribute(Constants.USER_ELSEINDENTITY_MODEL, userService.findElseIdentityList(user.getUserIdentity()));
    ...
    public Map<String, Object> resetPasswordAfterLogin(@RequestParam("oldPassword") String userOldPassword, @RequestParam("newPassword") String userNewPassword) {
        ...
        if (!(MySecurity.encryptUserPassword(userOldPassword, user.getUserId())).equals(user.getUserPassword())) {
            ...
            userService.updateResetPasswordByUserId(userNewPassword, user.getUserId());
