    ...
    <div class="layadmin-user-login-main">
        ...
        <div class="layadmin-user-login-box layadmin-user-login-body layui-form">
            <div class="layui-form-item">
                ...
                <input type="text" name="username" id="LAY-user-login-username" lay-verify="required" placeholder="用户名(学号或工号)" class="layui-input">
            </div>
            <div class="layui-form-item">
            ...
            <div class="layui-form-item" style="margin-bottom: 20px;">
                ...
                <a href="${ctx}/forget" class="layadmin-user-jump-change layadmin-link" style="margin-top: 7px;">忘记密码？</a>
            </div>
            <div class="layui-form-item">
                <button class="layui-btn layui-btn-fluid" lay-submit lay-filter="LAY-user-login-submit" id="my_button">登 入</button>
            </div>
...
<script src="${ctx}/static/custom/js/external/gVerify.js"></script> <%--图形验证码的放置与验证--%>
