                ...
                <div class="layui-tab-content">
                    <div class="layui-tab-item layui-show">
                        ...
                        <div style="padding-bottom: 10px;">
                            <button class="layui-btn layuiadmin-btn-comm" data-type="batchdel" id="query-my-info1">查询我的专业信息</button>
                            <button class="layui-btn layuiadmin-btn-comm" data-type="batchdel" style="background-color: #FFB800" id="query-all-info1">查询所有信息</button>
                        </div>
                    ...
                    <div class="layui-tab-item">
                        <div class="layui-tab-item layui-show">
                            ...
                            <div style="padding-bottom: 10px;">
                                <button class="layui-btn layuiadmin-btn-comm" data-type="batchdel" id="query-my-info2">查询我的学院信息</button>
                                <button class="layui-btn layuiadmin-btn-comm" data-type="batchdel" style="background-color: #FFB800" id="query-all-info2">查询所有信息</button>
                            </div>
